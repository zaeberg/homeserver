...
7. Добавить auth для сервисов (будет добавлено при возврате сервисов)
...
7. Добавить VPN (WireGuard) для удалённого доступа
8. Настроить логирование централизованно (Loki, ELK)
9. Добавить автоматическую генерацию документации из конфигов
